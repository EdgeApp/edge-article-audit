---
title: 'Web3: Decentralized Finance (DeFi) & Decentralized Apps (DApps)'
intercom_id: '13892576'
workspace_id: ourx4xix
state: published
default_locale: en
parent_type: null
parent_id: null
updated_at: 1772223119
description: >-
  Decentralized finance and decentralized apps are simply services that are able
  to operate without a single, centralized governing body. Th...
url: >-
  https://support.edge.app/en/articles/13892576-web3-decentralized-finance-defi-decentralized-apps-dapps
---
...
Users can contribute funds to a validator pool in *Proof of Stake* (PoS) blockchains to participate in the process which secures the network and produces blocks. The pool receives block rewards from the network (see [What are Gas Fees?](https://support.edge.app/hc/en-us/articles/7073734765595)) for the contribution and distributes these rewards to pool participants. Depending on the blockchain network, staking funds typically introduces another layer of risk (ex. counterparty and slashing). Stakers will often receive a liquid staking derivative (LSD, LST, LRT - see [Alternative Asset Types](https://support.edge.app/hc/en-us/articles/33931892646555)) to represent their holdings in the stake pool and to be used in other decentralized finance activities.
...
-   Catalog of cryptocurrency protocols
